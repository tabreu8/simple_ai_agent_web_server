...
from knowledge_base.chromadb import ChromaDBManager, get_chromadb_manager
from knowledge_base.doc_parsing import DocumentParser, get_document_parser
...
"""
        ...
        metadatas = [{"source": "integration_test", "chunk": i} for i in range(len(chunks))]
